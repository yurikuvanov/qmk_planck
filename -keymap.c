 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |ZH/Ctl|   A  |   S  |   D  |   F  |   G  |   H  |   J  |   K  |   L  |   ;  |  -   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |Shift |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |'/SFT |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Esc/f1|Adjust| Alt  | GUI  |英数/L|  SPC |  ENT  |かな/R| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_JIS] = {
  {FN2_TAB, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC},
  {CTL_ZH, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    WN_SCLN, KC_MINS },
  {KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_JQT},
  {FN1_ESC,  ADJUST,  KC_LALT, MY_GUI,  M_EMHL,  KC_SPC,  KC_ENT,  M_KHKR,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},

/* デフォルトレイヤー（ US配列で認識） */
[_US] = {
  {FN2_TAB, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC},
  {CTL_ZH, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_MINS },
  {KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_QT},
  {FN1_ESC,  ADJUST,  KC_LALT, KC_LGUI, M_EMHL,  KC_SPC,  KC_ENT,  M_KHRU,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |Esc/FN|      | Vol- | Vol+ | Mute |   .  | Left | Down |  Up  |Right |   *  |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_RAISE] = {
  ...
  {FN1_ESC, XXXXXXX, MY_VOLD, MY_VOLU, KC_MUTE, KC_DOT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PAST, _______},
...
[_LOWER] = {
  ...
  {_______, XXXXXXX, MY_VOLD, MY_VOLU, KC_MUTE, JP_TILD,  JP_YEN , JP_LBRC, JP_RBRC, JP_LCBR, JP_RCBR, JP_DQT},
  {WN_CAPS, XXXXXXX, KC_MRWD, KC_MFFD, KC_MPLY, JP_CIRC, JP_PIPE, JP_UNDS, JP_PLUS, JP_LT,    JP_GT, JP_QUOT},
...
[_LOWER_US] = {
  ...
  {_______, XXXXXXX, MY_VOLD, MY_VOLU, KC_MUTE, KC_TILD, JP_GRV,  KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_DQUO},
  {WN_CAPS, XXXXXXX, KC_MRWD, KC_MFFD, KC_MPLY, KC_CIRC, KC_TILD, KC_UNDS, KC_PLUS, KC_LT, KC_GT, KC_QUOT},
  {_______, _______, _______, _______, XXXXXXX, _______, _______, _______, _______, _______, _______, _______}
},
