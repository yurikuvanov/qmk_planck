...
[_JIS] = LAYOUT_planck_grid(
    ...
    KC_ESC,     KC_LCTL, KC_LALT, KC_LGUI, LT(LOWER,JP_MHEN),KC_SPC,KC_ENT,LT(RAISE,JP_HENK),KC_LEFT, KC_DOWN, KC_UP,KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
    _______, KC_EXLM, JP_AT,   KC_HASH, KC_DLR,  KC_PERC, JP_CIRC, JP_AMPR, JP_ASTR, JP_LPRN, JP_RPRN, KC_DEL,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, XXXXXXX, KC_VOLD, KC_VOLU, KC_MUTE, KC_DOT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PAST, _______,
